...
import { getDatabase,ref,set } from "firebase/database";
 const metadata: Metadata = {
  ...
  description: "To start the game plz signup",
  // other metadata
};
...
const onSubmit =async(e)=>{
  ...
  if(userPassword==userRetypePassword)
    {
      setIsLoading(true);
      await createUserWithEmailAndPassword(auth,userEmail,userPassword).then((cred)=>{
        alert("تم تسجيل الحساب بنجاح");
        setIsLoading(false);
        setUserData(cred.user.uid);
